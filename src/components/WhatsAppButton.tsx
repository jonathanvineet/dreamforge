...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute -inset-1 rounded-full bg-emerald-500/40 blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

      {/* Elongating Pill Button Container */}
      <div className="relative flex items-center justify-center h-14 min-w-[3.5rem] px-3.5 group-hover:px-5 bg-gradient-to-tr from-[#128C7E] via-[#25D366] to-[#25D366] text-white rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.4)] group-hover:shadow-[0_6px_28px_rgba(37,211,102,0.6)] transition-all duration-300 ease-out border border-white/20">
        {/* WhatsApp Icon */}
        <div className="flex items-center justify-center flex-shrink-0">
          <svg
            ...
            className="transform group-hover:rotate-12 transition-transform duration-300 drop-shadow-sm"
          >
        ...
        <span className="font-semibold text-sm tracking-wide whitespace-nowrap overflow-hidden max-w-0 opacity-0 group-hover:max-w-[140px] group-hover:opacity-100 group-hover:ml-2.5 transition-all duration-300 ease-out select-none">
          Chat with us
        </span>
      </div>
    </a>
